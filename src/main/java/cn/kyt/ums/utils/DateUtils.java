...
public class DateUtils {
    ...
    public static final String DEFAULT_DATE_FORMAT_TABLE = "yyyy年MM月dd日";
    ...
    public static String toDefDatetimeString(Date date) {
        return toString(date, DEFAULT_DATE_FORMAT_TABLE);
    }
   ...
   //比较两个时间大小
     ...
     * @return
     */
    public static Date randomDateTime(Date date, int upStart, int upEnd, int downStart, int downEnd){
        ...
        if(num>50){
            //设置时
            calendar.set(Calendar.HOUR_OF_DAY, getrandom(upStart,upEnd));
        }else{
            //设置时
            calendar.set(Calendar.HOUR_OF_DAY, getrandom(downStart,downEnd));
        }
        //设置分
